...
/**
 * Renders when the visitor is in preview mode. Either Supabase env vars
 * are unset in local dev, or the `mppga-preview` cookie was set by the
 * temporary sign-in skip-auth buttons. Makes it obvious that
